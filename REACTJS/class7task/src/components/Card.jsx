...
const Card = (props) => {
    ...
    return (
        <div className='border-2 border-amber-300 lg:w-[23vw] md:w-[30vw] sm:w-[45vw] rounded-xl py-8 px-8 flex items-center flex-col text-center bg-gray-600 text-black'>
          {/* Profile Pic */}
